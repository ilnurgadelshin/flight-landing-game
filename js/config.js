...
export const SCENARIOS = {
  ...
  tailwind: {
    ...
    turbulence: 0.25,
    visibility: 25000, cloudBase: 2500, cloudThickness: 1500,
    rain: 0, wet: false, lightning: false,
    timeOfDay: 'day',
    icon: '💨',
  },
  crosswind: {
    ...
    turbulence: 0.5,
    visibility: 20000, cloudBase: 1500, cloudThickness: 1100,
    rain: 0, wet: false, lightning: false,
    timeOfDay: 'day',
    icon: '↔️',
  },
  storm: {
    ...
    turbulence: 0.75,
    visibility: 900, cloudBase: 260, cloudThickness: 99999,
